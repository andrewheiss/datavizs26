...
0. Create a [new](https://datavizs26.classes.andrewheiss.com/lesson/01-lesson.html#part-3-rstudio-projects) **RStudio project** on your computer, or use an empty starter project here:
   ...
   - [{{< fa cloud >}} Posit.cloud project](https://posit.cloud/spaces/793460/content/12560272): Use this link if you're using Posit.cloud in your browser
