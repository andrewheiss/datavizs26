...
Here's your roadmap for the semester! (**scroll down to see a complete calendar!**)
...
show_table <- function(group_id) {
  ...
  if (str_detect(schedule_nested$group[[group_id]], "Special applications")) {
    cat('\n\n::: {.callout-important title="ATTENTION!"}
Sessions 11, 12, 13, and 14 are special. Choose **only one (1)** of these topics. You can do more for extra credit.
:::\n\n')
  }
