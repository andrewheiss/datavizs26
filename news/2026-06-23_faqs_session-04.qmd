...
Great work with session 4! You're getting the hang of grouping and summarizing, which is crucial for reshaping and manipulating all sorts of data before feeding it to `ggplot()`! 
