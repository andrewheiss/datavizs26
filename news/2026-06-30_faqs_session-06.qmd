...
There are no rules! [See this FAQ post from session 1 for more](/news/2026-06-16_faqs_session-01.qmd#my-histogram-bars-are-too-wide-too-narrow-not-visible.-how-do-i-fix-that).
...
Like, let's say you forget that you need to use `+` in between ggplot layers and you use a pipe (`|>`) instead ([remember the difference here](/news/2026-06-23_faqs_session-03.qmd#why-do-we-sometimes-combine-code-with-and-sometimes-with)).
...
I'll use that same theme throughout a project. Typing all those little theme tweaks is annoying, but you can reuse them—[see this FAQ from session 5](/news/2026-06-30_faqs_session-05.qmd#if-i-want-to-use-the-same-theme-for-all-the-plots-in-my-document-do-i-need-to-reuse-all-that-code-all-the-time)!
