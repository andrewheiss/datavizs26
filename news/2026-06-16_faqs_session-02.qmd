...
This is a tricky quirk of using Quarto. In Markdown, the `#` symbol is how you [create headings](/news/2026-06-12_cleaner-nicer-qmd-output.qmd#headings-that-aren't-headings), and you can combine them to create nested headings and subheadings:
