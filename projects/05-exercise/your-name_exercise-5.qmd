---
title: "Themes"
subtitle: "Exercise 5 --- PMAP 8551/4551, Summer 2026"
...
- The image is 6 inches wide and 3 inches tall. Use chunk options like `fig-width` and `fig-height` to control the dimensions (see <https://datavizs26.classes.andrewheiss.com/resource/quarto.html#chunk-options>)
...
**MAKE SURE** you use [the theme resources and cheatsheets from the content page](https://datavizs26.classes.andrewheiss.com/content/05-content.html#readings-you-should-glance-through-and-use-as-resources). Also [consider using {ggthemeassist}](https://datavizs26.classes.andrewheiss.com/example/05-example.html#bonus-ggthemeassist) to help with the different settings.
